...
import { Calendar, Users, CheckCircle, Clock, LogOut, Search, Phone, Mail, MapPin, Car, Bell, Send, BarChart3 } from 'lucide-react';
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-orange-600">{stats['in-progress']}</p>
                </div>
                ...
                <CardContent className="p-6 space-y-6">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <Button 
                        onClick={() => updateBookingStatus(selectedBooking.bookingId, 'in-progress')}
