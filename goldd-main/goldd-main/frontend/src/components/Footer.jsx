        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mb-4">
              Calgary's premier mobile cleaning service. Home cleaning and car wash bringing professional care to your doorstep.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center space-x-2">
                ...
                <a
                  href="mailto:goldentouchcleaningservice25@gmail.com"
